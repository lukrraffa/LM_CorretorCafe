...
if (!isset($_GET["id"])) {
    ...
    if ($id_cliente == 0) {
        ...
        include("conecta.php");
        $cliente = RetornaClientePorId($id_cliente);
        if ($cliente != null) {
            ...
            <div class="painel">
                <form action="salvar_cliente.php" method="POST">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label text-right" for="cTipoCliente">Tipo do cliente</label>
                        <div class="col-sm-8">
                            <select class="form-control" type="text" name="txtTipoCliente" id="cTipoCliente" value="<?php echo $tipoCliente; ?>">
                                <option value="Pessoa Física">Pessoa física</option>
                                <option value="Exportador">Exportador</option>
                                <option value="Corretor">Corretor</option>
                                <option value="Torrefadora">Torrefadora</option>
                    ...
                    <br>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label text-right" for="cNome">Nome do cliente</label>
                        <div class="col-sm-8">
                            <input class="form-control" type="text" name="txtNome" id="cNome" placeholder="Digite o nome do cliente (pessoa física ou empresa)" value="<?php echo $nome; ?>">
                        </div>
                    </div>
                    <br>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label text-right" for="cRepresentante">Representante (Empresa)</label>
                        <div class="col-sm-8">
                            <input class="form-control" type="text" name="txtRepresentante" id="cRepresentante" placeholder="Digite o nome do representante (caso for empresa)" value="<?php echo $representante; ?>">
                        </div>
                    </div>
                    <br>
                    <div class="form-group row">
